...
public class Day13_1 {
    ...
    static boolean checkPosInField(List<String> lines, int posLeft) {
        for (int l = 0; l < lines.size(); l++) {
            if (!checkPosInLine(lines.get(l), posLeft)) {
                return false;
            }
        }
        return true;
    ...
    static boolean checkPosInLine(String line, int posLeft) {
        ...
        // left and right have equal size
            ...
            return line.substring(0, candidateLeft).equals(
                    new StringBuilder(line.substring(candidateRight)).reverse()
            );
        }
