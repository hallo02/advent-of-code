...
public class Day5_1 {
    ...
    public static void main(String... args) {
        ...
        List<Triple> seedToSoil = getSeedToSoil();
        List<Triple> soilToFert = getSoilToFert();
        List<Triple> fertToWater = getFertToWater();
        List<Triple> waterToLight = getWaterToLight();
        List<Triple> lightToTemp = getLightToTemperature();
        List<Triple> tempToHumidity = getTemperatureToHumidity();
        List<Triple> humidityToLocation = getHumidityToLocation();

        var result = seeds.stream()
                .mapToLong(n -> access(seedToSoil, n))
    ...
    static Long access(List<Triple> triple, Long searchFor) {
        ...
        triple = new LinkedList<Triple>(triple);
        triple.sort(Comparator.comparingLong(t -> t.srcStart));
        ...
        System.out.println("Search for " + searchFor + " in triple:");
